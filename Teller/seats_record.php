...
<body>
    ...
    if (isset($_POST['button'])) {
        ...
        $CUSTOMER_PASSWORD =  $_POST['phone'];
        $CUSTOMER_NAME =  $_POST['user'];
        $CUSTOMER_PHONE =  $_POST['phone'];
        $CUSTOMER_EMAIL =  $_POST['email'];
        $CUSTOMER_CNIC =  $_POST['nic'];

        $_SESSION['cstid'] = $CUSTOMER_USERNAME;
        $_SESSION['PWD'] = $CUSTOMER_PHONE;
    ...
    if (isset($_POST['bc'])) {
        ...
        echo '<form class="signup" action="seats_record.php" method="post">
                    <h1>Customer information</h1>
                    <div class="textbox">
                      <input type="text" placeholder="Customer name" name="user"  required>
                    </div>
                    ...
                    <div class="textbox">
                      <input type="text" placeholder="CNIC" name="nic" value="" required>
                    </div>
